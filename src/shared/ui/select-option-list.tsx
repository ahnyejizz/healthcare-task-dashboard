      ...
      {options.map((option, index) => (
        ...
        >
          <button
            type="button"
            className={[
              "flex w-full items-center justify-between rounded-xl px-3 py-1 text-sm font-medium transition-colors",
          ...
          >
            <span>{renderLabel ? renderLabel(option) : option.label}</span>
            {selectedValue === option.value ? (
